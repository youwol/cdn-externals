!function(t) {
    ...
    T.defineMode("xml", function(t, e) {
        var i, a, l = t.indentUnit, u = {}, n = e.htmlMode ? y : z;
        for (var r in n)
            u[r] = n[r];
        for (var r in e)
            u[r] = e[r];
        function c(e, n) {
            ...
            n.tokenize = d,
            "tag bracket") : "&" != r ? (e.eatWhile(/[^&<]/),
            null) : (e.eat("#") ? e.eat("x") ? e.eatWhile(/[a-fA-F\d]/) && e.eat(";") : e.eatWhile(/[\d]/) && e.eat(";") : e.eatWhile(/[\w\.\-:]/) && e.eat(";")) ? "atom" : "error"
        }
        function d(t, e) {
            var n = t.next();
            if (">" == n || "/" == n && t.eat(">"))
        ...
        function h(t, e, n) {
            if ("word" != t)
                return u.allowMissingTagName && "endTag" == t ? (a = "tag bracket",
                x(t, e, n)) : (a = "error",
                b);
            var r = e.current();
            return n.context && n.context.tagName != r && u.implicitlyClosed.hasOwnProperty(n.context.tagName) && f(n),
        ...
        function k(t, e, n) {
            ...
            "selfcloseTag" == t || u.autoSelfClosers.hasOwnProperty(r) ? m(n, r) : (m(n, r),
            n.context = new s(n,r,o == n.indented)),
            g
        }
        function w(t, e, n) {
            ...
            indent: function(t, e, n) {
                ...
                if (o && o[1])
                    for (; r; ) {
                        ...
                        if (!u.implicitlyClosed.hasOwnProperty(r.tagName))
                            break;
                        r = r.prev
                    }
                else if (o)
