!function(e, t) {
    ...
    function gt(e, t) {
        ...
        return t.line > o ? at(o, et(e, o).text.length) : (n = et(e, (r = t).line).text.length,
        null == (i = r.ch) || n < i ? at(r.line, n) : i < 0 ? at(r.line, 0) : r)
    }
    function vt(e, t) {
    ...
    function gr(e, t) {
        ...
        if (r.length) {
            ...
            fr ? n = fr.delayedCallbacks : pr ? n = pr : (n = pr = [],
            setTimeout(vr, 0));
    ...
    function zr(e, t) {
        var r = it(t)
          , n = Ir(e, r);
        n && !n.text ? n = null : n && n.changes && (mr(e, n, r, cn(e)),
    ...
    function Rr(e, t, r, n, i) {
        ...
        t.hasHeights = !0),
        (o = function(e, t, r, n) {
            var i, o = Ur(t.map, r, n), l = o.node, s = o.start, a = o.end, u = o.collapse;
            if (3 == l.nodeType) {
                for (var c = 0; c < 4; c++) {
    ...
    function qr(e, t, r, n, i) {
        ...
        n = n || "local";
        var l = Zt(t);
        if ("local" == n ? l += Or(e.display) : l -= e.display.viewOffset,
        "page" == n || "window" == n) {
    ...
    function sn(r, e, t, n, i) {
        ...
        var f, d, p = null, g = null, v = le(function(e) {
            ...
            return t.top += l,
            t.bottom += l,
            ln(t, n, i, !1) && (t.top <= i && t.left <= n && (p = e,
            g = t),
            1)
        }, s, a), m = !1;
        if (g) {
    ...
    function vn(e, t, r, n) {
        ...
        t >= i.viewTo)
            ...
            At && _t(e.doc, r + n) > i.viewFrom ? yn(e) : (i.viewFrom += n,
            i.viewTo += n);
    ...
    function bn(e, t, r, n) {
        var i, o = gn(e, t), l = e.display.view;
    ...
    function Jn(e) {
        ...
        !(r = (t = n).display).scrollbarsClipped && r.scroller.offsetWidth && (r.nativeBarWidth = r.scroller.offsetWidth - r.scroller.clientWidth,
    ...
    function ei(e) {
        ...
        e.barMeasure = Vn(t),
        r.maxLineChanged && !t.options.lineWrapping && (e.adjustWidthTo = Er(t, r.maxLine, r.maxLine.text.length).left + 3,
        t.display.sizerWidth = e.adjustWidthTo,
        e.barMeasure.scrollWidth = Math.max(r.scroller.clientWidth, r.sizer.offsetLeft + e.adjustWidthTo + Wr(t) + t.display.barWidth),
        e.maxScrollLeft = Math.max(0, r.sizer.offsetLeft + e.adjustWidthTo - Hr(t))),
    ...
    function ti(e) {
        ...
        e.maxScrollLeft < t.doc.scrollLeft && Un(t, Math.min(t.display.scroller.scrollLeft, e.maxScrollLeft), !0),
        ...
        e.scrollToPos && function(e, t) {
            ...
            for (var o = 0; o < 5; o++) {
                var l = !1
                  ...
                  , c = e.doc.scrollTop
                  , h = e.doc.scrollLeft;
                if (null != u.scrollTop && (Bn(e, u.scrollTop),
                1 < Math.abs(e.doc.scrollTop - c) && (l = !0)),
                null != u.scrollLeft && (Un(e, u.scrollLeft),
        ...
        if (!(u.highlightFrontier >= a.display.viewTo)) {
            ...
            u.iter(h.line, Math.min(u.first + u.size, a.display.viewTo + 500), function(e) {
                if (h.line >= a.display.viewFrom) {
                    ...
                    h.nextLine();
                if (+new Date > c)
                    return si(a, a.options.workDelay),
                    !0
            }),
    ...
    function ci(e, t) {
        ...
        a = o,
        u = l,
        0 == (c = (s = e).display).view.length || a >= c.viewTo || u <= c.viewFrom ? (c.view = hr(s, a, u),
        c.viewFrom = a) : (c.viewFrom > a ? c.view = hr(s, a, c.viewFrom).concat(c.view) : c.viewFrom < a && (c.view = c.view.slice(gn(s, a))),
        c.viewFrom = a,
        c.viewTo < u ? c.view = c.view.concat(hr(s, c.viewTo, u)) : c.viewTo > u && (c.view = c.view.slice(0, gn(s, u)))),
        c.viewTo = u,
        ...
        h && (r.lastWrapHeight = t.wrapperHeight,
        r.lastWrapWidth = t.wrapperWidth,
        si(e, 400)),
        !(r.updateLineNumbers = null)
    }
    function hi(e, t) {
        for (var r = t.viewport, n = !0; (n && e.options.lineWrapping && t.oldDisplayWidth != Hr(e) || (r && null != r.top && (r = {
            top: Math.min(e.doc.height + Ar(e.display) - Fr(e), r.top)
        }),
        t.visible = Hn(e.display, e.doc, r),
        !(t.visible.from >= e.display.viewFrom && t.visible.to <= e.display.viewTo))) && ci(e, t); n = !1) {
            Dn(e);
            var i = Vn(e);
            xn(e),
            Xn(e, i),
    ...
    function ki(e, t) {
        ...
        if (n && s || i && a) {
            ...
            if (n && !g && !v && null != Ci)
                return i && a && Bn(e, Math.max(0, l.scrollTop + i * Ci)),
            ...
            xi < 20 && (null == o.wheelStartX ? (o.wheelStartX = l.scrollLeft,
    ...
    function Di(e, t) {
        ...
        var r = e.line + t.text.length - (t.to.line - t.from.line) - 1
          , n = e.ch;
        return e.line == t.to.line && (n += Ai(t).ch - t.to.ch),
        at(r, n)
    }
    function Wi(e, t) {
    ...
    function Ki(e, t, r, n) {
        ...
        if ((i.lastOp == n || i.lastOrigin == t.origin && t.origin && ("+" == t.origin.charAt(0) && i.lastModTime > a - (e.cm ? e.cm.options.historyEventDelay : 500) || "*" == t.origin.charAt(0))) && (o = (s = i).lastOp == n ? (Vi(s.done),
        $(s.done)) : s.done.length && !$(s.done).ranges ? $(s.done) : 1 < s.done.length && !s.done[s.done.length - 2].ranges ? (s.done.pop(),
        $(s.done)) : void 0))
            l = $(o.changes),
            0 == ut(t.from, t.to) && 0 == ut(t.from, l.to) ? l.to = Ai(t) : o.changes.push(Ui(e, t));
        else {
            var u = $(i.done);
            for (u && u.ranges || Xi(e.sel, i.done),
            o = {
                changes: [Ui(e, t)],
    ...
    function ji(e, t, r, n) {
        var i, o, l, s, a, u = e.history, c = n && n.origin;
        r == u.lastSelOp || c && u.lastSelOrigin == c && (u.lastModTime == u.lastSelTime && u.lastOrigin == c || (i = e,
        o = c,
        l = $(u.done),
        s = t,
        "*" == (a = o.charAt(0)) || "+" == a && l.ranges.length == s.ranges.length && l.somethingSelected() == s.somethingSelected() && new Date - i.history.lastSelTime <= (i.cm ? i.cm.options.historyEventDelay : 500))) ? u.done[u.done.length - 1] = t : Xi(t, u.done),
    ...
    function io(e, t, r) {
        var n, i, o, l;
        (Te(e, "beforeSelectionChange") || e.cm && Te(e.cm, "beforeSelectionChange")) && (n = e,
        o = r,
        l = {
            ranges: (i = t).ranges,
            update: function(e) {
                ...
                if ((null == s.from || (u ? s.from <= t.ch : s.from < t.ch)) && (null == s.to || (c ? s.to >= t.ch : s.to > t.ch))) {
                    ...
                    if (r) {
                        var h = a.find(n < 0 ? 1 : -1)
                          , f = void 0;
                        if ((n < 0 ? c : u) && (h = co(e, h, -n, h && h.line == t.line ? o : null)),
                        h && h.line == t.line && (f = ut(h, r)) && (n < 0 ? f < 0 : 0 < f))
                            return ao(e, h, t, n, i)
                    }
                    var d = a.find(n < 0 ? -1 : 1);
                    return (n < 0 ? u : c) && (d = co(e, d, n, d.line == t.line ? o : null)),
                    d ? ao(e, d, t, n, i) : null
                }
            }
        return t
    ...
    function go(e, r) {
        if (1 != r.text.length || "" != r.text[0] || 0 != ut(r.from, r.to)) {
            ...
            var n = [];
            zi(e, function(e, t) {
                t || -1 != B(n, e.history) || (Co(e.history, r),
                n.push(e.history)),
                yo(e, r, null, Ft(e, r))
            })
        }
    ...
    function mo(e, t) {
        if (0 != t && (e.first += t,
        e.sel = new Ti(q(e.sel.ranges, function(e) {
    ...
    function So(e, t, r, n) {
        ...
        null == i ? null : (n(o, i) && e.cm && mn(e.cm, i, r),
        o)
    }
    function Lo(e) {
        this.lines = e,
    ...
    Oo.prototype.clear = function() {
        if (!this.explicitlyCleared) {
            ...
            for (var n = null, i = null, o = 0; o < this.lines.length; ++o) {
                ...
                e && !this.collapsed ? mn(e, it(l), "text") : e && (null != s.to && (i = it(l)),
                null != s.from && (n = it(l))),
            ...
            if (t && !n.isReadOnly())
                if (r && r.length && window.FileReader && window.File)
                    ...
                    try {
                        ...
                        if (c) {
                            var h;
                            if (n.state.draggingText && !n.state.draggingText.copy && (h = n.listSelections()),
                            io(n.doc, Oi(t, t)),
                            h)
    ...
    function ol(t, r, s, e) {
        ...
        function o(e) {
            return t.options.lineWrapping ? (l = l || zr(t, r),
            on(t, r, l, e)) : {
                begin: 0,
                end: r.text.length
            }
    ...
    function gl(e) {
        ...
        !Le(t, e)) {
            ...
            var n, i = dl(t, e);
            v && (pl = i ? r : null,
            !i && 88 == r && !Ue && (w ? e.metaKey : e.ctrlKey) && t.replaceSelection("", null, "cut")),
            g && !w && !i && 46 == r && e.shiftKey && !e.ctrlKey && document.execCommand && document.execCommand("cut"),
            18 != r || /\bCodeMirror-crosshair\b/.test(t.display.lineDiv.className) || (H(n = t.display.lineDiv, "CodeMirror-crosshair"),
            we(document, "keyup", o),
            we(document, "mouseover", o))
        }
        function o(e) {
            18 != e.keyCode && e.altKey || (T(n, "CodeMirror-crosshair"),
            Ce(document, "keyup", o),
    ...
    function xl(e) {
        ...
        if (!(Le(t, e) || r.activeTouch && r.input.supportsTouch()))
            ...
            Nr(r, e))
                ...
                var n, i, o, l = pn(t, e), s = He(e), a = l ? (n = l,
                i = s,
                o = +new Date,
                bl && bl.compare(o, n, i) ? (yl = bl = null,
                "triple") : yl && yl.compare(o, n, i) ? (bl = new wl(o,n,i),
                yl = null,
                "double") : (yl = new wl(o,n,i),
                bl = null,
                "single")) : "single";
                window.focus(),
                ...
                l && function(r, e, n, t, i) {
                    ...
                    (e.options.dragDrop && Ee && !e.isReadOnly() && "single" == r && -1 < (i = l.contains(t)) && (ut((i = l.ranges[i]).from(), t) < 0 || 0 < t.xRel) && (0 < ut(i.to(), t) || t.xRel < 0) ? function(t, r, n, i) {
                        var o = t.display
                          ...
                          , s = ii(t, function(e) {
                            ...
                            l || (Ne(e),
                            i.addNew || Qi(t.doc, n, null, null, i.extend),
                    ...
                    : function(v, e, m, y) {
                        ...
                        w = -1 < x ? t[x] : new Mi(m,m)) : (w = b.sel.primary(),
                        x = b.sel.primIndex);
                        if ("rectangle" == y.unit)
                        ...
                        C = b.sel) : eo(b, x, w, K) : (no(b, new Ti([w],x = 0), K),
                        C = b.sel);
                        var S = m;
                        function s(e) {
                            if (0 != ut(S, e))
                                ...
                                "rectangle" == y.unit) {
                                    ...
                                    var h, f = w, d = Cl(v, e, y.unit), p = f.anchor;
                ...
                }(t, l, a, e) : We(e) == r.scroller && Ne(e) : 2 == s ? (l && Qi(t.doc, l),
                setTimeout(function() {
    ...
    function kl(e, t) {
        var r, n;
        Nr(e.display, t) || (n = t,
        Te(r = e, "gutterContextMenu") && Sl(r, n, "gutterContextMenu", !1)) || Le(e, t, "contextmenu") || S || e.display.input.onContextMenu(t)
    }
    function Tl(e) {
    ...
    function Wl(e, t) {
        ...
        function(i) {
            ...
            we(o.scroller, "scroll", function() {
                o.scroller.clientHeight && (Bn(i, o.scroller.scrollTop),
                ...
                start: function(e) {
                    return function(e, t) {
                        if (x && (!e.state.draggingText || new Date - Eo < 100))
                            De(t);
                        else if (!Le(e, t) && !Nr(e.display, t) && (t.dataTransfer.setData("Text", e.getSelection()),
        ...
        Ri(this, n),
        t.autofocus && !f || this.hasFocus() ? setTimeout(E(On, this), 20) : An(this),
        Ol)
    ...
    function Fl(e, t, r, n) {
        ...
        if (f < u && (h += _(u - f)),
        h != c)
            return bo(o, h, at(t, 0), at(t, c.length), "+input"),
            !(s.stateAfter = null);
    ...
    function zl(e, t) {
        ...
        t.isReadOnly() || t.options.disableInput || ni(t, function() {
    ...
    function Vl(n, i, o, e, l) {
        ...
        function u(e) {
            ...
            if (null == (t = l ? ol(n.cm, s, i, o) : nl(s, i, o))) {
                if (e || (r = i.line + a) < n.first || r >= n.first + n.size || (i = new at(r,i.ch,i.sticky),
                !(s = et(n, r))))
                    return;
    ...
    jl.prototype.pollContent = function() {
        ...
        l.line < i.viewFrom || s.line > i.viewTo - 1)
            return !1;
        r = l.line == i.viewFrom || 0 == (e = gn(n, l.line)) ? (t = it(i.view[0].line),
        i.view[0].node) : (t = it(i.view[e].line),
        i.view[e - 1].node.nextSibling);
        var a, u, c = gn(n, s.line);
        ...
        for (var h = n.doc.splitLines(function(a, e, t, u, c) {
            ...
            function v(e) {
                if (1 == e.nodeType) {
                    ...
                    if (n) {
                        var i = a.findMarks(at(u, 0), at(c + 1, 0), (s = +n,
                        function(e) {
                            return e.id == s
                        }
                        ));
        ...
        return 1 < h.length || h[0] || ut(x, C) ? (bo(n.doc, h, x, C, "+input"),
        !0) : void 0
    }
    ,
    ...
    jl.prototype.onKeyPress = function(e) {
        ...
        this.cm.isReadOnly() || ii(this.cm, Il)(this.cm, String.fromCharCode(null == e.charCode ? e.keyCode : e.charCode), 0))
    }
    ,
    ...
    ql.prototype.init = function(r) {
        ...
        we(o, "paste", function(e) {
            Le(i, e) || zl(e, i) || (i.state.pasteIncoming = +new Date,
            n.fastPoll())
        }),
        we(o, "cut", t),
        we(o, "copy", t),
    ...
    ql.prototype.onContextMenu = function(e) {
        ...
        function d() {
            ...
            null != o.selectionStart)) {
                ...
                var e = 0
                  , t = function() {
                    i.selForContextMenu == n.doc.sel && 0 == o.selectionStart && 0 < o.selectionEnd && "​" == r.prevInput ? ii(n, ho)(n) : e++ < 10 ? i.detectingSelectAll = setTimeout(t, 500) : (i.selForContextMenu = null,
                    i.input.reset())
                };
    ...
    Jl.prototype = {
        ...
        indentSelection: oi(function(e) {
            for (var t = this.doc.sel.ranges, r = -1, n = 0; n < t.length; n++) {
                var i = t[n];
                if (i.empty())
                    i.head.line > r && (Fl(this, i.head.line, e, !0),
                    r = i.head.line,
        ...
        addWidget: function(e, t, r, n, i) {
            var o, l, s, a = this.display, u = (e = Jr(this, gt(this.doc, e))).bottom, c = e.left;
            ...
            "right" == i ? (c = a.sizer.clientWidth - t.offsetWidth,
            t.style.right = "0px") : ("left" == i ? c = 0 : "middle" == i && (c = (a.sizer.clientWidth - t.offsetWidth) / 2),
            t.style.left = c + "px"),
            r && (o = this,
            l = {
                left: c,
        ...
        moveV: oi(function(n, i) {
            ...
            if (l.extendSelectionsBy(function(e) {
                ...
                s.push(t.left);
                var r = Kl(o, t, n, i);
                return "page" == i && e == l.sel.primary() && Pn(o, Qr(o, r, "div").top - t.top),
                r
            }, j),
            s.length)
        ...
        toggleOverwrite: function(e) {
            null != e && e == this.state.overwrite || (((this.state.overwrite = !this.state.overwrite) ? H : T)(this.display.cursorDiv, "CodeMirror-overwrite"),
        ...
        scrollIntoView: oi(function(e, t) {
            ...
            zn(r = this),
            r.curOp.scrollToPos = n) : Rn(this, e.from, e.to, e.margin)
        }),
    ...
    ;
    var ns, is = "iter insert remove copy getEditor constructor".split(" ");
    ...
    Wl.fromTextArea = function(t, r) {
        ...
        r.finishInit = function(e) {
            ...
            e.toTextArea = function() {
                ...
                r.leaveSubmitMethodAlone || "function" != typeof t.form.submit || (t.form.submit = i))
            }
        }
        ,
