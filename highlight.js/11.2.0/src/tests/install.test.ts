...
import * as originalPackage from 'highlight.js'
...
test('install highlight.js', async () => {
    // This test the default import
    ...
    const webpmPackage =
        globalThis[`${setup.name}_APIv${setup.apiVersion}`].default
